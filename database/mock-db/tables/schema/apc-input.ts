...
const typeName = 'SoftwareHouse.NextGen.Common.SecurityObjects.ApcInput';
const schema = {
    'FullClassName': 'SoftwareHouse.NextGen.Common.SecurityObjects.ApcInput',
    'LocalizedName': 'apC Input',
    'IsUserSelectable': true,
    'LocalityType': 'LocalOnly',
    'Description': 'An input associated with an apC controller.',
    'IsGroupable': true,
    'PropertyList': [
        {
            'Name': 'Name',
        ...
        },
        {
            ...
            'Type': 'Boolean',
            'IsEnum': false,
            'Description': '*** ApcInputMaintenanceModeToolTipText ***',
            'IsUdf': false
        },
        {
            'Name': 'MonitorState',
